...
export default function ComparisonGrid() {
  ...
  const isLockedForOthers = useMemo(() => {
    // Lock predictions for others until June 8, 2026 at 11:00:00 UTC (2 days before World Cup)
      ...
      {isLockedForOthers && (
        <div className="bg-amber-500/10 border border-amber-500/25 rounded-2xl p-4 flex items-start gap-3 text-amber-400 backdrop-blur-sm animate-fadeIn">
          ...
          <div className="text-xs">
            ...
            <p className="text-slate-350 leading-relaxed">Por políticas de juego limpio, los pronósticos de los demás usuarios estarán ocultos hasta el <strong>8 de junio de 2026 a las 11:00 UTC</strong> (2 días antes del inicio del Mundial). ¡Tus propias predicciones siguen siendo visibles para ti!</p>
          </div>
        </div>
      )}
